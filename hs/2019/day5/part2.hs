...
interpretProgram xs x
    ...
    | o == 3 = interpretProgram (replace (xs !! (x+1)) 5 xs) (x+2)
    | o == 4 = interpretProgram (xs++[p1]) (x+2)
    | o == 5 = interpretProgram xs (if p1 /= 0 then p2 else x+3)    
    | o == 6 = interpretProgram xs (if p1 == 0 then p2 else x+3)
    | o == 7 = interpretProgram (if p1 < p2 then replace p3 1 xs else replace p3 0 xs) (x+4)
    | o == 8 = interpretProgram (if p1 == p2 then replace p3 1 xs else replace p3 0 xs) (x+4)
    | o == 99 = xs
